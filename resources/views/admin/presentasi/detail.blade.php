...
@section('content')
    <style>
        ...
        /* --- Buttons --- */
        .btn-maroon {
            background-color: var(--custom-maroon); color: white; border: none;
            ...
            @if ($presentasi->status_final == 'selesai')
                <div class="custom-card border-top border-4 border-success">
                    <div class="p-4 d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="fw-bold text-success mb-1"><i class="bi bi-patch-check-fill me-2"></i>Prosedur Telah Selesai</h5>
